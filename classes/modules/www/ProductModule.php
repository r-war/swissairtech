...
class ProductModule extends AbstractCommonModule
{
  protected $oNews;
  ...
  public function doBuildTemplate()
  {
    ...
    $this->aContext['products'] = NewsPeer::getByType('Products', $this->doHandleParameter(), null, $this->getPageList(), $oPager, 10);
