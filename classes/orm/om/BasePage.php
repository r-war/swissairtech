...
abstract class BasePage extends BaseObject  implements Persistent {
	 ...
	 * Note: this column has a database default value of: 'page'
	 * @var        string
	 */
	protected $type;
	...
	/**
	 * @var        array PageTab[] Collection to store aggregation of PageTab objects.
	 */
	protected $collPageTabs;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPageTabs.
	 */
	private $lastPageTabCriteria = null;
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PagePeer::DATE;
			}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = PagePeer::CODE;
		}
	...
	public function setPicture($v)
	{
		...
		if ($this->picture !== $v) {
			$this->picture = $v;
			$this->modifiedColumns[] = PagePeer::PICTURE;
		}
	...
	public function setShortDesc($v)
	{
		...
		if ($this->short_desc !== $v) {
			$this->short_desc = $v;
			$this->modifiedColumns[] = PagePeer::SHORT_DESC;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(PagePeer::SORT_ORDER,PagePeer::LANGUAGE,PagePeer::TYPE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->picture = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->short_desc = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			return $startcol + 10; // 10 = PagePeer::NUM_COLUMNS - PagePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collPageTabs = null;
			$this->lastPageTabCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collPageTabs !== null) {
				foreach ($this->collPageTabs as $referrerFK) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PagePeer::DATE)) $criteria->add(PagePeer::DATE, $this->date);
		if ($this->isColumnModified(PagePeer::CODE)) $criteria->add(PagePeer::CODE, $this->code);
		if ($this->isColumnModified(PagePeer::NAME)) $criteria->add(PagePeer::NAME, $this->name);
		if ($this->isColumnModified(PagePeer::PICTURE)) $criteria->add(PagePeer::PICTURE, $this->picture);
		if ($this->isColumnModified(PagePeer::SHORT_DESC)) $criteria->add(PagePeer::SHORT_DESC, $this->short_desc);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getPageTabs() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addPageTab($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collPageTabs collection (array).
	 *
	 ...
	 * @see        addPageTabs()
	 */
	public function clearPageTabs()
	{
		$this->collPageTabs = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collPageTabs collection (array).
	 *
	 * By default this just sets the collPageTabs collection to an empty array (like clearcollPageTabs());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initPageTabs()
	{
		$this->collPageTabs = array();
	}

	/**
	 * Gets an array of PageTab objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Page has previously been saved, it will retrieve
	 * related PageTabs from storage. If this Page is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array PageTab[]
	 * @throws     PropelException
	 */
	public function getPageTabs($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PagePeer::DATABASE_NAME);
		}
		...
		if ($this->collPageTabs === null) {
			if ($this->isNew()) {
			   $this->collPageTabs = array();
				...
				$criteria->add(PageTabPeer::PAGE_ID, $this->id);

				PageTabPeer::addSelectColumns($criteria);
				$this->collPageTabs = PageTabPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				PageTabPeer::addSelectColumns($criteria);
				if (!isset($this->lastPageTabCriteria) || !$this->lastPageTabCriteria->equals($criteria)) {
					$this->collPageTabs = PageTabPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastPageTabCriteria = $criteria;
		return $this->collPageTabs;
	}

	/**
	 * Returns the number of related PageTab objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related PageTab objects.
	 * @throws     PropelException
	 */
	public function countPageTabs(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PagePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collPageTabs === null) {
			if ($this->isNew()) {
				...
				$count = PageTabPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a PageTab object to this object
	 * through the PageTab foreign key attribute.
	 *
	 * @param      PageTab $l PageTab
	 * @return     void
	 * @throws     PropelException
	 */
	public function addPageTab(PageTab $l)
	{
		if ($this->collPageTabs === null) {
			$this->initPageTabs();
		}
		if (!in_array($l, $this->collPageTabs, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPageTabs, $l);
			$l->setPage($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collPageTabs) {
				foreach ((array) $this->collPageTabs as $o) {
