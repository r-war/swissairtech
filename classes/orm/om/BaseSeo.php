...
abstract class BaseSeo extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseSeo object.
	 * @see        applyDefaults()
	 */
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = SeoPeer::URL;
		}
	...
	public function setMetaTitle($v)
	{
		...
		if ($this->meta_title !== $v) {
			$this->meta_title = $v;
			$this->modifiedColumns[] = SeoPeer::META_TITLE;
		}
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = SeoPeer::META_KEYWORDS;
		}
	...
	public function setMetaDescription($v)
	{
		...
		if ($this->meta_description !== $v) {
			...
			$this->modifiedColumns[] = SeoPeer::META_DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = SeoPeer::NUM_COLUMNS - SeoPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += SeoPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SeoPeer::URL)) $criteria->add(SeoPeer::URL, $this->url);
		if ($this->isColumnModified(SeoPeer::META_TITLE)) $criteria->add(SeoPeer::META_TITLE, $this->meta_title);
		if ($this->isColumnModified(SeoPeer::META_KEYWORDS)) $criteria->add(SeoPeer::META_KEYWORDS, $this->meta_keywords);
		if ($this->isColumnModified(SeoPeer::META_DESCRIPTION)) $criteria->add(SeoPeer::META_DESCRIPTION, $this->meta_description);
