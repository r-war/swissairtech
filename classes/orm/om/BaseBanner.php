...
abstract class BaseBanner extends BaseObject  implements Persistent {
	...
	public function setLanguage($v)
	{
		...
		if ($this->language !== $v) {
			$this->language = $v;
			$this->modifiedColumns[] = BannerPeer::LANGUAGE;
		}
	...
	public function setGroup($v)
	{
		...
		if ($this->group !== $v) {
			$this->group = $v;
			$this->modifiedColumns[] = BannerPeer::GROUP;
		}
	...
	public function setIndex($v)
	{
		...
		if ($this->index !== $v) {
			$this->index = $v;
			$this->modifiedColumns[] = BannerPeer::INDEX;
		}
	...
	public function setPicture($v)
	{
		...
		if ($this->picture !== $v) {
			$this->picture = $v;
			$this->modifiedColumns[] = BannerPeer::PICTURE;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = BannerPeer::URL;
		}
	...
	public function setNewTab($v)
	{
		...
		if ($this->new_tab !== $v || $v === false) {
			$this->new_tab = $v;
			$this->modifiedColumns[] = BannerPeer::NEW_TAB;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = BannerPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = BannerPeer::DESCRIPTION;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(BannerPeer::NEW_TAB))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->group = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->index = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->picture = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->url = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->new_tab = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BannerPeer::LANGUAGE)) $criteria->add(BannerPeer::LANGUAGE, $this->language);
		if ($this->isColumnModified(BannerPeer::GROUP)) $criteria->add(BannerPeer::GROUP, $this->group);
		if ($this->isColumnModified(BannerPeer::INDEX)) $criteria->add(BannerPeer::INDEX, $this->index);
		if ($this->isColumnModified(BannerPeer::PICTURE)) $criteria->add(BannerPeer::PICTURE, $this->picture);
		if ($this->isColumnModified(BannerPeer::URL)) $criteria->add(BannerPeer::URL, $this->url);
		if ($this->isColumnModified(BannerPeer::NEW_TAB)) $criteria->add(BannerPeer::NEW_TAB, $this->new_tab);
		if ($this->isColumnModified(BannerPeer::NAME)) $criteria->add(BannerPeer::NAME, $this->name);
		if ($this->isColumnModified(BannerPeer::DESCRIPTION)) $criteria->add(BannerPeer::DESCRIPTION, $this->description);
